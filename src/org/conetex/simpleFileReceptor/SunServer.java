...
public class SunServer extends Thread {
    ...
    public SunServer(Socket client) {
      ...
      try {
        ...
        if (httpMethod.equals("GET")) {
            ...
            if (httpQueryString.equals("/")) {
                     ...
                     String responseString = SunServer.HTML_START +
    ...
    public void sendResponse (int statusCode, String responseString, boolean isFile) throws Exception {
        ...
        if (isFile) {
            ...
            responseString = SunServer.HTML_START + responseString + SunServer.HTML_END;
